...
(cstruct #.(swig-lispify "starpu_codelet" 'classname) "struct starpu_codelet"
         ...
         (#.(swig-lispify "modes" 'slotname) "modes" :type #.(swig-lispify "starpu_data_access_mode" 'enumname) :count STARPU_NMAXBUFS)
         ...
         (#.(swig-lispify "dyn_nodes" 'slotname) "dyn_nodes" :type (:pointer :int))
...
(cstruct #.(swig-lispify "starpu_vector_interface" 'classname) "struct starpu_vector_interface"
         (#.(swig-lispify "id" 'slotname) "id" :type #.(swig-lispify "starpu_data_interface_id" 'enumname))
         (#.(swig-lispify "ptr" 'slotname) "ptr" :type :pointer)
         (#.(swig-lispify "dev_handle" 'slotname) "dev_handle" :type :pointer)
         (#.(swig-lispify "offset" 'slotname) "offset" :type :size)
         (#.(swig-lispify "nx" 'slotname) "nx" :type :uint32)
         (#.(swig-lispify "elemsize" 'slotname) "elemsize" :type :size)
         (#.(swig-lispify "slice_base" 'slotname) "slice_base" :type :uint32)
         (#.(swig-lispify "allocsize" 'slotname) "allocsize" :type :size))
...
(cstruct #.(swig-lispify "starpu_matrix_interface" 'classname) "struct starpu_matrix_interface"
         ...
         (#.(swig-lispify "offset" 'slotname) "offset" :type :size)
         (#.(swig-lispify "nx" 'slotname) "nx" :type :uint32)
         (#.(swig-lispify "ny" 'slotname) "ny" :type :uint32)
         (#.(swig-lispify "ld" 'slotname) "ld" :type :uint32)
         (#.(swig-lispify "elemsize" 'slotname) "elemsize" :type :size)
         (#.(swig-lispify "allocsize" 'slotname) "allocsize" :type :size))
...
(cstruct #.(swig-lispify "starpu_block_interface" 'classname) "struct starpu_block_interface"
         ...
         (#.(swig-lispify "nx" 'slotname) "nx" :type :uint32)
         (#.(swig-lispify "ny" 'slotname) "ny" :type :uint32)
         (#.(swig-lispify "ny" 'slotname) "nz" :type :uint32)
         (#.(swig-lispify "ldy" 'slotname) "ldy" :type :uint32)
         (#.(swig-lispify "ldz" 'slotname) "ldz" :type :uint32)
         (#.(swig-lispify "elemsize" 'slotname) "elemsize" :type :size))
